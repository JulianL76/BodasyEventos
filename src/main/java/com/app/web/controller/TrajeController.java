...
public class TrajeController {
    ...
    public String guardarTraje(@ModelAttribute Traje traje, @RequestParam("images") List<MultipartFile> images, SessionStatus status) throws IOException {
    	 List<String> imagenes = new ArrayList<>();
    	for (MultipartFile image : images) {
             if (!image.isEmpty()) {
                 // Realiza el procesamiento de cada imagen aquí
                 String uniqueFileName = uploadFileService.copy(image);
                 // Puedes guardar estos nombres de archivo en una lista en tu entidad Meme, por ejemplo
